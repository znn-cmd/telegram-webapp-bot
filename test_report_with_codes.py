#!/usr/bin/env python3
"""
Тестовый скрипт для проверки отчета с кодами локаций
"""
...
def test_report_with_codes():
    """
    Тестирует отчет с кодами локаций
    """
    print("🚀 Тест отчета с кодами локаций")
    print("=" * 50)

...
def api_save_html_report():
    ...
    try:
        ...
        # Локализация для HTML отчета
        def get_report_text(key, lang):
            translations = {
                'ru': {
                    'title': 'Аналитический отчет по недвижимости',
                    'document_title': 'АНАЛИТИЧЕСКИЙ ОТЧЕТ ПО НЕДВИЖИМОСТИ',
                    'report_number': 'Номер отчета:',
                    'generation_date': 'Дата формирования:',
                    'generation_time': 'Время формирования:',
                    'system_analysis': 'Система анализа:',
                    'report_type': 'Тип отчета:',
                    'status': 'Статус:',
                    'property_evaluation': 'Оценка объекта недвижимости',
                    'automatically_generated': 'Автоматически сгенерирован',
                    'qr_verification': 'QR-код для верификации отчета',
                    'location_info': 'ИНФОРМАЦИЯ О ЛОКАЦИИ',
                    'region': 'Регион:',
                    ...
                    'disclaimer': 'Данный отчет автоматически сгенерирован системой Aaadviser на основании анализа исторических данных и текущего предложения, экономических данных региона и открытой статистики продаж. Анализ носит рекомендательный характер и не является официальной оценкой недвижимости. Для принятия инвестиционных решений рекомендуется консультация со специалистами.',
                    'verification_title': 'Проверка актуальности данных',
                    'verification_text': 'Для проверки актуальности данных и верификации отчета перейдите по ссылке:',
                    'footer_system': 'Система аналитики недвижимости',
                    'footer_generated': 'Сформирован',
                    'footer_rights': 'Все права защищены.',
                    'sale_forecast': 'Прогноз продажи',
                    'rent_forecast': 'Прогноз аренды'
                },
                'en': {
                    'title': 'Real Estate Analytics Report',
                    'document_title': 'REAL ESTATE ANALYTICS REPORT',
                    'report_number': 'Report Number:',
                    'generation_date': 'Generation Date:',
                    'generation_time': 'Generation Time:',
                    'system_analysis': 'Analysis System:',
                    'report_type': 'Report Type:',
                    'status': 'Status:',
                    'property_evaluation': 'Property Evaluation',
                    'automatically_generated': 'Automatically Generated',
                    'qr_verification': 'QR code for report verification',
                    ...
                    'disclaimer': 'This report is automatically generated by the Aaadviser system based on analysis of historical data and current supply, regional economic data and open sales statistics. The analysis is advisory in nature and is not an official property valuation. For investment decisions, consultation with specialists is recommended.',
                    'verification_title': 'Data Verification',
                    'verification_text': 'To verify data accuracy and report verification, follow the link:',
                    'footer_system': 'Real Estate Analytics System',
                ...
                'de': {
                    'title': 'Immobilien-Analysebericht',
                    'document_title': 'IMMOBILIEN-ANALYSEBERICHT',
                    'report_number': 'Berichtsnummer:',
                    'generation_date': 'Erstellungsdatum:',
                    'generation_time': 'Erstellungszeit:',
                    'system_analysis': 'Analysesystem:',
                    'report_type': 'Berichtstyp:',
                    'status': 'Status:',
                    'property_evaluation': 'Immobilienbewertung',
                    'automatically_generated': 'Automatisch generiert',
                    'qr_verification': 'QR-Code zur Berichtsverifizierung',
                    ...
                    'disclaimer': 'Dieser Bericht wurde automatisch vom Aaadviser-System basierend auf der Analyse historischer Daten und des aktuellen Angebots, regionaler Wirtschaftsdaten und offener Verkaufsstatistiken erstellt. Die Analyse ist beratender Natur und stellt keine offizielle Immobilienbewertung dar. Für Investitionsentscheidungen wird eine Beratung durch Spezialisten empfohlen.',
                    'verification_title': 'Datenverifikation',
                    'verification_text': 'Zur Überprüfung der Datenaktualität und Berichtsverifizierung folgen Sie dem Link:',
                    'footer_system': 'Immobilien-Analysesystem',
                    'footer_generated': 'Erstellt',
                    'footer_rights': 'Alle Rechte vorbehalten.',
                    'sale_forecast': 'Verkaufsprognose',
                    'rent_forecast': 'Mietprognose'
                },
                'fr': {
                    'title': 'Rapport d\'analyse immobilière',
                    'document_title': 'RAPPORT D\'ANALYSE IMMOBILIÈRE',
                    'report_number': 'Numéro de rapport:',
                    'generation_date': 'Date de génération:',
                    'generation_time': 'Heure de génération:',
                    'system_analysis': 'Système d\'analyse:',
                    'report_type': 'Type de rapport:',
                    'status': 'Statut:',
                    'property_evaluation': 'Évaluation immobilière',
                    'automatically_generated': 'Généré automatiquement',
                    'qr_verification': 'QR code pour vérification du rapport',
                    'location_info': 'INFORMATIONS DE LOCALISATION',
                    'region': 'Région:',
                    'analysis_type': 'Type d\'analyse:',
                    'bedrooms': 'Nombre de chambres:',
                    'floor': 'Étage:',
                    'age': 'Âge de la propriété:',
                    'heating': 'Type de chauffage:',
                    'price': 'Prix de la propriété:',
                    'area': 'Superficie:',
                    'important_info': 'Informations importantes',
                    'disclaimer': 'Ce rapport est automatiquement généré par le système Aaadviser basé sur l\'analyse de données historiques et de l\'offre actuelle, des données économiques régionales et des statistiques de vente ouvertes. L\'analyse est de nature consultative et ne constitue pas une évaluation immobilière officielle. Pour les décisions d\'investissement, une consultation avec des spécialistes est recommandée.',
                    'verification_title': 'Vérification des données',
                    'verification_text': 'Pour vérifier l\'exactitude des données et la vérification du rapport, suivez le lien:',
                    'footer_system': 'Système d\'analyse immobilière',
                    'footer_generated': 'Généré',
                    'footer_rights': 'Tous droits réservés.',
                    'sale_forecast': 'Prévision de vente',
                    'rent_forecast': 'Prévision de location'
                },
                'tr': {
                    'title': 'Gayrimenkul Analiz Raporu',
                    'document_title': 'GAYRİMENKUL ANALİZ RAPORU',
                    'report_number': 'Rapor Numarası:',
                    'generation_date': 'Oluşturma Tarihi:',
                    'generation_time': 'Oluşturma Zamanı:',
                    'system_analysis': 'Analiz Sistemi:',
                    'report_type': 'Rapor Türü:',
                    'status': 'Durum:',
                    'property_evaluation': 'Mülk Değerlendirmesi',
                    'automatically_generated': 'Otomatik Oluşturuldu',
                    'qr_verification': 'Rapor doğrulama için QR kodu',
                    'location_info': 'KONUM BİLGİSİ',
                    'region': 'Bölge:',
                    ...
                    'disclaimer': 'Bu rapor, Aaadviser sistemi tarafından tarihi verilerin analizi ve mevcut arz, bölgesel ekonomik veriler ve açık satış istatistikleri temelinde otomatik olarak oluşturulmuştur. Analiz danışmanlık niteliğindedir ve resmi bir gayrimenkul değerlendirmesi değildir. Yatırım kararları için uzmanlarla görüşülmesi önerilir.',
                    'verification_title': 'Veri Doğrulama',
                    'verification_text': 'Veri doğruluğunu ve rapor doğrulamasını kontrol etmek için bağlantıyı takip edin:',
                    'footer_system': 'Gayrimenkul Analiz Sistemi',
                    'footer_generated': 'Oluşturuldu',
                    'footer_rights': 'Tüm hakları saklıdır.',
                    'sale_forecast': 'Satış Tahmini',
                    'rent_forecast': 'Kira Tahmini'
                }
            }
...
<head>
    ...
    <title>{get_report_text('title', report_language)} - {location_info}</title>
...
<body>
    <div class="document">
        ...
        <div class="corporate-header">
            ...
            <div class="document-title">{get_report_text('document_title', report_language)}</div>
        ...
        <div class="report-metadata">
            <div class="metadata-grid">
                <div>
                    <div class="metadata-item">
                        <span class="metadata-label">{get_report_text('report_number', report_language)}</span>
                        <span class="metadata-value">{report_number}</span>
                    </div>
                    <div class="metadata-item">
                        <span class="metadata-label">{get_report_text('generation_date', report_language)}</span>
                        <span class="metadata-value">{datetime.now().strftime("%d.%m.%Y")}</span>
                    </div>
                    <div class="metadata-item">
                        <span class="metadata-label">{get_report_text('generation_time', report_language)}</span>
                        <span class="metadata-value">{datetime.now().strftime("%H:%M:%S")} UTC</span>
                    </div>
                </div>
                <div>
                    <div class="metadata-item">
                        <span class="metadata-label">{get_report_text('system_analysis', report_language)}</span>
                        <span class="metadata-value">Aaadviser v2.0</span>
                    </div>
                    <div class="metadata-item">
                        <span class="metadata-label">{get_report_text('report_type', report_language)}</span>
                        <span class="metadata-value">{get_report_text('property_evaluation', report_language)}</span>
                    </div>
                    <div class="metadata-item">
                        <span class="metadata-label">{get_report_text('status', report_language)}</span>
                        <span class="metadata-value">{get_report_text('automatically_generated', report_language)}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="qr-section">
                ...
                <div class="qr-label">{get_report_text('qr_verification', report_language)}</div>
            </div>
        </div>
        ...
        <div class="location-object-info">
            <div class="location-info-section">
                <h3 class="info-section-title">{get_report_text('location_info', report_language)}</h3>
                <div class="info-grid">
                    <div class="info-item">
                        <span class="info-label">{get_report_text('region', report_language)}</span>
                        <span class="info-value">{location_info}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">{get_report_text('analysis_type', report_language)}</span>
                        <span class="info-value">{get_report_text('property_evaluation', report_language)}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">{get_report_text('bedrooms', report_language)}</span>
                        <span class="info-value">{report_data.get('bedrooms', 'Не указано')}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">{get_report_text('floor', report_language)}</span>
                        <span class="info-value">{report_data.get('floor', 'Не указано')}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">{get_report_text('age', report_language)}</span>
                        <span class="info-value">{report_data.get('age', 'Не указано')}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">{get_report_text('heating', report_language)}</span>
                        <span class="info-value">{report_data.get('heating', 'Не указано')}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">{get_report_text('price', report_language)}</span>
                        <span class="info-value">{report_data.get('price', 'Не указано')}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">{get_report_text('area', report_language)}</span>
                            ...
                            const controlsHtml = `
                                <div class="chart-controls" style="margin-bottom: 15px; text-align: center;">
                                    <button class="chart-button active" data-chart-type="sale" onclick="switchForecastChartType('sale')" style="background: #9b59b6; color: white; border: none; padding: 8px 16px; margin: 0 5px; border-radius: 4px; cursor: pointer; font-size: 12px;">
                                        {get_report_text('sale_forecast', report_language)}
                                    </button>
                                    <button class="chart-button" data-chart-type="rent" onclick="switchForecastChartType('rent')" style="background: #6c757d; color: white; border: none; padding: 8px 16px; margin: 0 5px; border-radius: 4px; cursor: pointer; font-size: 12px;">
                                        {get_report_text('rent_forecast', report_language)}
                                    </button>
                                </div>
                            `;
        ...
        <div class="corporate-footer">
            <div class="disclaimer">
                <div class="disclaimer-title">{get_report_text('important_info', report_language)}</div>
                <div class="disclaimer-text">
                    {get_report_text('disclaimer', report_language)}
                </div>
            </div>
            
            <div class="verification-section">
                <div class="verification-title">{get_report_text('verification_title', report_language)}</div>
                <div>
                    {get_report_text('verification_text', report_language)} 
                    <a href="{verification_url}" class="verification-link" target="_blank">{verification_url}</a>
                </div>
            </div>
            
            <div class="footer-info">
                <strong>Aaadviser</strong> - {get_report_text('footer_system', report_language)}<br>
                Отчет №{report_number} | {get_report_text('footer_generated', report_language)} {datetime.now().strftime("%d.%m.%Y в %H:%M:%S")}<br>
                © 2024 Aaadviser. {get_report_text('footer_rights', report_language)}
            </div>
        </div>
    </div>

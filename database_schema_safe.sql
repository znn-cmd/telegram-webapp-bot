-- =====================================================
-- БЕЗОПАСНАЯ версия схемы базы данных для системы недвижимости
-- Можно выполнять несколько раз без ошибок
-- =====================================================
...
-- Пользователи системы (если таблица не существует)
DO $$ 
BEGIN
...
DO $$
BEGIN
    -- Триггер для short_term_rentals
    ...
    -- Триггер для user_reports
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_user_reports_updated_at') THEN
